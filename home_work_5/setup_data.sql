...
insert into customer.customer (first_name, last_name, email, phone)
...
insert into customer.product_customer_discount (discount, start_date, finish_date, customer_id, supplier_product_id)
...
insert into customer.category_customer_discount (discount, start_date, finish_date, customer_id, category_id)
...
insert into customer.customer_sub_order (amount, supplier_product_price_id)
values (1.0, 1),
       (2.0, 2),
       (3.0, 3),
       (4.0, 4),
...
insert into customer.customer_order (created_timestamp, payed_timestamp, total_price, total_discount, customer_id,
                                     customer_order_status_id)
values (timestamp '2021-08-06 12:30:30', timestamp '2021-08-06 12:35:40', 0.0, 0.0, 1, 2),
       (timestamp '2021-08-06 13:30:30', timestamp '2021-08-06 13:35:40', 0.0, 0.0, 2, 2);

-- Заполняем связи подзаказов с заказами покупателей
insert into customer.customer_order_detail (customer_order_id, customer_sub_order_id)
values (1, 1),
       (1, 2),
       (1, 3),
       (1, 4),
...
insert into customer.customer_delivery_location (customer_id, location_info_id)
values (1, 7),
       (2, 8);

-- Заполняем доставки заказов
insert into customer.customer_order_delivery (delivery_date, delivery_info, customer_order_id, delivery_type_id,
