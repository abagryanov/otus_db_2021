...
create table customer.customer_role
(
    customer_role_id serial primary key,
    customer_id      int not null,
    role_id          int not null,
    constraint FK_CustomerRole_CustomerId foreign key (customer_id) references customer.customer (customer_id),
    constraint FK_CustomerRole_RoleId foreign key (role_id) references customer.role (role_id)
);
...
(
    category_customer_discount_id serial primary key,
    discount                     numeric not null,
    start_date                   date    not null,
    finish_date                  date    not null,
    customer_id                  int     not null,
