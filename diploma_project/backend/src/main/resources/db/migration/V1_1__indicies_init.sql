-- Table customer.customer_role
create index customer_role_customer_id_idx on customer.customer_role (customer_id);
create index customer_role_role_id_idx on customer.customer_role (role_id);
